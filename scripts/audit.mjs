...
assert.equal(JSON.parse(actor.exampleRunInput.body).maxVideosPerChannel, 5);
assert.equal(JSON.parse(actor.exampleRunInput.body).includeShorts, true);
assert.equal(JSON.parse(actor.exampleRunInput.body).maxShortsPerChannel, 5);
assert.equal(JSON.parse(actor.exampleRunInput.body).includePlaylists, false);
assert.equal(JSON.parse(actor.exampleRunInput.body).includeCommunityPosts, true);
assert.equal(JSON.parse(actor.exampleRunInput.body).maxCommunityPostsPerChannel, 3);
